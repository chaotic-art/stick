module.exports = class Data1760160000000 {
    ...
    async up(db) {
        ...
        await db.query(`CREATE INDEX "IDX_nft_entity_rarity_score" ON "nft_entity" ("rarity_score") `)
        await db.query(`CREATE INDEX "IDX_nft_entity_rarity_rank" ON "nft_entity" ("rarity_rank") `)
        await db.query(`CREATE INDEX "IDX_nft_entity_rarity_percentile" ON "nft_entity" ("rarity_percentile") `)
        await db.query(`CREATE INDEX "IDX_nft_entity_rarity_tier" ON "nft_entity" ("rarity_tier") `)
    ...
    async down(db) {
        ...
        await db.query(`DROP INDEX "public"."IDX_nft_entity_rarity_tier"`)
        await db.query(`DROP INDEX "public"."IDX_nft_entity_rarity_percentile"`)
        await db.query(`DROP INDEX "public"."IDX_nft_entity_rarity_rank"`)
        await db.query(`DROP INDEX "public"."IDX_nft_entity_rarity_score"`)
