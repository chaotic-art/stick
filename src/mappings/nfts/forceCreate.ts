...
import md5 from 'md5'
import { CollectionEntity as CE, CollectionKind } from '../../model'
...
/**
 * Handle the collection force create event (Nfts.ForceCreated)
...
export async function handleForceCollectionCreate(context: Context): Promise<void> {
  ...
  final.collectionType = CollectionKind.NFTS
